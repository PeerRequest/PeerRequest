...
<Container>
  ...
  <div class="w-full flex justify-end">
    <Button color="primary" size="xs" on:click={() => show_submit_modal = true}>Submit Paper</Button>
  </div>
...
<SubmitPaperModal hide="{() => show_submit_modal = false}" show="{show_submit_modal}" conference_type="{mocks[data.category_id - 1].type}"/>
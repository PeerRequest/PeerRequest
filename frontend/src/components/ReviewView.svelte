...
<div class="flex flex-auto h-full">
    <div class="p-4 w-[100%] lg:w-[50%] overflow-auto">
        <Tabs style="underline">
            ...
            <TabItem>
                <div class="flex items-center gap-2" slot="title">
                    <svg aria-hidden="true" class="w-5 h-5" style="enable-background:new 0 0 87.881 87.881;" viewBox="0 0 87.881 87.881" x="0px"
            ...
            <TabItem>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400"><b>Message board:</b>
                    <MessageBoard/>
                </p>
            </TabItem>
        </Tabs>
